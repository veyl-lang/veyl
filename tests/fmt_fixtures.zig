...
test "formatter golden: impl interface and test" {
    const source = @embedFile("fixtures/fmt/impl_interface_test.input.veyl");
    const expected = @embedFile("fixtures/fmt/impl_interface_test.expected.veyl");
...
test "formatter golden: match patterns" {
    const source = @embedFile("fixtures/fmt/match_patterns.input.veyl");
    const expected = @embedFile("fixtures/fmt/match_patterns.expected.veyl");
...
test "formatter golden: where clauses" {
    const source = @embedFile("fixtures/fmt/where_clauses.input.veyl");
    const expected = @embedFile("fixtures/fmt/where_clauses.expected.veyl");
